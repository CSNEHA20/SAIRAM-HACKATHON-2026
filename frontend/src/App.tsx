...
export const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-slate-950 text-slate-100 overflow-hidden font-sans">
      {/* Top Navbar */}
      <header className="h-14 border-b border-slate-800/80 bg-slate-950/80 px-4 md:px-6 flex items-center justify-between shrink-0 backdrop-blur-md z-10">
      ...
      <div className="flex-1 flex overflow-hidden">
        ...
        <aside className="hidden xl:flex w-72 border-l border-slate-800/80 bg-slate-950/60 p-4 flex-col gap-4 shrink-0 overflow-hidden">
          {/* Stream Status Inspector */}
          <div className="rounded-xl glass-panel p-3 border border-slate-800/80 text-xs text-slate-400 space-y-2">
            ...
            <div className="flex items-center justify-between font-mono text-[11px] pt-1">
              ...
              <span className="font-semibold text-cyan-400 capitalize">{status}</span>
            </div>
